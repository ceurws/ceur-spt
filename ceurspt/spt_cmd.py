...
class CeurSptCmd:
    ...
    def get_arg_parser(self,description:str,version_msg)->ArgumentParser:
        ...
        parser.add_argument("--host",default=self.get_default_host(),help="the host to serve / listen from [default: %(default)s]")
    ...
    def start(self,args):
        ...
        """
        ws=WebServer()        
        uvicorn.run(ws.app,host=args.host, port=args.port, debug=args.debug)
