...
slots.number = Slot(
    uri=CEURWSSCHEMA.number,
    name="number",
    curie=CEURWSSCHEMA.curie("number"),
    model_uri=CEURWSSCHEMA.number,
    domain=None,
    range=Optional[float],
)

slots.acronym = Slot(
    uri=CEURWSSCHEMA.acronym,
    name="acronym",
    curie=CEURWSSCHEMA.curie("acronym"),
    model_uri=CEURWSSCHEMA.acronym,
    domain=None,
    range=Optional[str],
)

slots.wikidataid = Slot(
    uri=CEURWSSCHEMA.wikidataid,
    name="wikidataid",
    curie=CEURWSSCHEMA.curie("wikidataid"),
    model_uri=CEURWSSCHEMA.wikidataid,
    domain=None,
    range=Optional[str],
)

slots.title = Slot(
    uri=CEURWSSCHEMA.title,
    name="title",
    curie=CEURWSSCHEMA.curie("title"),
    model_uri=CEURWSSCHEMA.title,
    domain=None,
    range=Optional[str],
)

slots.description = Slot(
    uri=CEURWSSCHEMA.description,
    name="description",
    curie=CEURWSSCHEMA.curie("description"),
    model_uri=CEURWSSCHEMA.description,
    domain=None,
    range=Optional[str],
)

slots.url = Slot(
    uri=CEURWSSCHEMA.url,
    name="url",
    curie=CEURWSSCHEMA.curie("url"),
    model_uri=CEURWSSCHEMA.url,
    domain=None,
    range=Optional[str],
)

slots.date = Slot(
    uri=CEURWSSCHEMA.date,
    name="date",
    curie=CEURWSSCHEMA.curie("date"),
    model_uri=CEURWSSCHEMA.date,
    domain=None,
    range=Optional[Union[str, XSDDate]],
)

slots.dblp = Slot(
    uri=CEURWSSCHEMA.dblp,
    name="dblp",
    curie=CEURWSSCHEMA.curie("dblp"),
    model_uri=CEURWSSCHEMA.dblp,
    domain=None,
    range=Optional[str],
)

slots.k10plus = Slot(
    uri=CEURWSSCHEMA.k10plus,
    name="k10plus",
    curie=CEURWSSCHEMA.curie("k10plus"),
    model_uri=CEURWSSCHEMA.k10plus,
    domain=None,
    range=Optional[str],
)

slots.urn = Slot(
    uri=CEURWSSCHEMA.urn,
    name="urn",
    curie=CEURWSSCHEMA.curie("urn"),
    model_uri=CEURWSSCHEMA.urn,
    domain=None,
    range=Optional[str],
)

slots.volume = Slot(
    uri=CEURWSSCHEMA.volume,
    name="volume",
    curie=CEURWSSCHEMA.curie("volume"),
    model_uri=CEURWSSCHEMA.volume,
    domain=None,
    range=Optional[Union[dict, Volume]],
)

slots.id = Slot(
    uri=CEURWSSCHEMA.id,
    name="id",
    curie=CEURWSSCHEMA.curie("id"),
    model_uri=CEURWSSCHEMA.id,
    domain=None,
    range=Optional[str],
)

slots.pdfUrl = Slot(
    uri=CEURWSSCHEMA.pdfUrl,
    name="pdfUrl",
    curie=CEURWSSCHEMA.curie("pdfUrl"),
    model_uri=CEURWSSCHEMA.pdfUrl,
    domain=None,
    range=Optional[Union[str, URI]],
)

slots.session = Slot(
    uri=CEURWSSCHEMA.session,
    name="session",
    curie=CEURWSSCHEMA.curie("session"),
    model_uri=CEURWSSCHEMA.session,
    domain=None,
    range=Optional[Union[dict, Session]],
)

slots.volume__number = Slot(
    uri=CEURWSSCHEMA.number,
    name="volume__number",
    curie=CEURWSSCHEMA.curie("number"),
    model_uri=CEURWSSCHEMA.volume__number,
    domain=None,
    range=Optional[float],
)

slots.volume__acronym = Slot(
    uri=CEURWSSCHEMA.acronym,
    name="volume__acronym",
    curie=CEURWSSCHEMA.curie("acronym"),
    model_uri=CEURWSSCHEMA.volume__acronym,
    domain=None,
    range=Optional[str],
)

slots.volume__wikidataid = Slot(
    uri=CEURWSSCHEMA.wikidataid,
    name="volume__wikidataid",
    curie=CEURWSSCHEMA.curie("wikidataid"),
    model_uri=CEURWSSCHEMA.volume__wikidataid,
    domain=None,
    range=Optional[str],
)

slots.volume__title = Slot(
    uri=CEURWSSCHEMA.title,
    name="volume__title",
    curie=CEURWSSCHEMA.curie("title"),
    model_uri=CEURWSSCHEMA.volume__title,
    domain=None,
    range=Optional[str],
)

slots.volume__description = Slot(
    uri=CEURWSSCHEMA.description,
    name="volume__description",
    curie=CEURWSSCHEMA.curie("description"),
    model_uri=CEURWSSCHEMA.volume__description,
    domain=None,
    range=Optional[str],
)

slots.volume__url = Slot(
    uri=CEURWSSCHEMA.url,
    name="volume__url",
    curie=CEURWSSCHEMA.curie("url"),
    model_uri=CEURWSSCHEMA.volume__url,
    domain=None,
    range=Optional[str],
)

slots.volume__date = Slot(
    uri=CEURWSSCHEMA.date,
    name="volume__date",
    curie=CEURWSSCHEMA.curie("date"),
    model_uri=CEURWSSCHEMA.volume__date,
    domain=None,
    range=Optional[Union[str, XSDDate]],
)

slots.volume__dblp = Slot(
    uri=CEURWSSCHEMA.dblp,
    name="volume__dblp",
    curie=CEURWSSCHEMA.curie("dblp"),
    model_uri=CEURWSSCHEMA.volume__dblp,
    domain=None,
    range=Optional[str],
)

slots.volume__k10plus = Slot(
    uri=CEURWSSCHEMA.k10plus,
    name="volume__k10plus",
    curie=CEURWSSCHEMA.curie("k10plus"),
    model_uri=CEURWSSCHEMA.volume__k10plus,
    domain=None,
    range=Optional[str],
)

slots.volume__urn = Slot(
    uri=CEURWSSCHEMA.urn,
    name="volume__urn",
    curie=CEURWSSCHEMA.curie("urn"),
    model_uri=CEURWSSCHEMA.volume__urn,
    domain=None,
    range=Optional[str],
)

slots.session__title = Slot(
    uri=CEURWSSCHEMA.title,
    name="session__title",
    curie=CEURWSSCHEMA.curie("title"),
    model_uri=CEURWSSCHEMA.session__title,
    domain=None,
    range=Optional[str],
)

slots.session__volume = Slot(
    uri=CEURWSSCHEMA.volume,
    name="session__volume",
    curie=CEURWSSCHEMA.curie("volume"),
    model_uri=CEURWSSCHEMA.session__volume,
    domain=None,
    range=Optional[Union[dict, Volume]],
)

slots.paper__description = Slot(
    uri=CEURWSSCHEMA.description,
    name="paper__description",
    curie=CEURWSSCHEMA.curie("description"),
    model_uri=CEURWSSCHEMA.paper__description,
    domain=None,
    range=Optional[str],
)

slots.paper__id = Slot(
    uri=CEURWSSCHEMA.id,
    name="paper__id",
    curie=CEURWSSCHEMA.curie("id"),
    model_uri=CEURWSSCHEMA.paper__id,
    domain=None,
    range=Optional[str],
)

slots.paper__wikidataid = Slot(
    uri=CEURWSSCHEMA.wikidataid,
    name="paper__wikidataid",
    curie=CEURWSSCHEMA.curie("wikidataid"),
    model_uri=CEURWSSCHEMA.paper__wikidataid,
    domain=None,
    range=Optional[str],
)

slots.paper__title = Slot(
    uri=CEURWSSCHEMA.title,
    name="paper__title",
    curie=CEURWSSCHEMA.curie("title"),
    model_uri=CEURWSSCHEMA.paper__title,
    domain=None,
    range=Optional[str],
)

slots.paper__pdfUrl = Slot(
    uri=CEURWSSCHEMA.pdfUrl,
    name="paper__pdfUrl",
    curie=CEURWSSCHEMA.curie("pdfUrl"),
    model_uri=CEURWSSCHEMA.paper__pdfUrl,
    domain=None,
    range=Optional[Union[str, URI]],
)

slots.paper__volume = Slot(
    uri=CEURWSSCHEMA.volume,
    name="paper__volume",
    curie=CEURWSSCHEMA.curie("volume"),
    model_uri=CEURWSSCHEMA.paper__volume,
    domain=None,
    range=Optional[Union[dict, Volume]],
)

slots.paper__session = Slot(
    uri=CEURWSSCHEMA.session,
    name="paper__session",
    curie=CEURWSSCHEMA.curie("session"),
    model_uri=CEURWSSCHEMA.paper__session,
    domain=None,
    range=Optional[Union[dict, Session]],
)
