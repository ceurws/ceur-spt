...
class Test_CEURWS(BaseSptTest):
    ...
    def test_fix_links(self):
        ...
        if debug:
            print(html)
        self.assertTrue(
            """<link href="/static/ceur-ws.css" rel="stylesheet" type="text/css"/>"""
            in html
        )
    ...
    def test_paper_as_html(self):
        ...
        self.assertTrue(
            "Towards improving Wikidata reuse with emerging patterns" in html
        )
    ...
    def test_paper_as_smw_markup(self):
        ...
        if debug:
            print(markup)
        self.assertTrue(
            "|dblpUrl=https://dblp.org/rec/conf/semweb/FerrantiPSA22" in markup
        )
